 ...
 *
 */
public class RevcShortvideoMessage extends AbstractRevcMessage {
	...
	public RevcShortvideoMessage() {
		super();
	}

	public RevcShortvideoMessage(String toUserName, String fromUserName,
