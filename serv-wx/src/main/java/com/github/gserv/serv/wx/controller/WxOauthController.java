...
import com.github.gserv.serv.wx.support.api.oauth.WxOauthContext;
...
public class WxOauthController implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		WxOauthContext.OauthScope oauthScope = WxOauthContext.OauthScope.snsapi_base;
		try {
			oauthScope = WxOauthContext.OauthScope.valueOf(scope);
		} catch (Exception e) {}
		// 构建认证上下文
		...
		String url = oauthApiUrl + "?appid=" + wxApiAccessTokenService.appId() 
				...
				+ "&response_type=code"
				+ "&scope=" + (oauthScope == WxOauthContext.OauthScope.snsapi_userinfo_only ? WxOauthContext.OauthScope.snsapi_userinfo : WxOauthContext.OauthScope.snsapi_base)
